...
> **Claude Code を Docker コンテナで動かしている場合**（コンテナ1つで完結、
> または EC2 の上に複数コンテナ）は、入れる場所と繋ぎ方が変わります。
> → **[Docker コンテナでの入れ方（amd64 / dnf 系）](INSTALL-docker.md)**
...
**[Docker コンテナでの入れ方（amd64 / dnf 系）](INSTALL-docker.md)** にあります。
